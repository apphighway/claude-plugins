...
In Claude Code, type `/plugins` → **Marketplace** tab → **Add Marketplace** → enter:

```
apphighway/claude-plugins
```

Then select any tool from the list to install it. Restart Claude Code after installation.
